  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'childOrder',
        name: 'childOrder',
        component: () => import('@/views/oms/order/childOrder'),
        meta: { title: '子订单列表', icon: 'product-list' }
      },
      {
        path: 'shipOrder',
        name: 'shipOrder',
        component: () => import('@/views/oms/order/shipOrder'),
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'lottery',
        name: 'lottery',
        component: () => import('@/views/sms/lottery/index'),
        meta: { title: '优惠券列表', icon: 'sms-coupon' }
      },
      {
        path: 'addCoupon',
