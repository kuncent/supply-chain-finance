  ...
  <div style="margin-top: 50px">
    ...
    >
      ...
      <el-form-item label="商家店铺：" prop="shopId">
        <el-select v-model="value.shopId" @change="handleBrandChange" placeholder="请选择品牌">
          <el-option
...
import { fetchList as fetchBrandList, fetchShopList } from "@/api/brand";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        shopId: [
          { required: true, message: "请选择商家店铺", trigger: "blur" }
        ],
        description: [
